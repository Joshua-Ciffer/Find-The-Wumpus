...
/**
 * This class represents one tile of the game board.  It contains variables that keep track of its position on the board
 * and what items are stored at that tile.
 * 
